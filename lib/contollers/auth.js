...
const { FAILED_ADD_NEW_USER, TEMPORARY_PASSWORD_EXPIRED, INVALID_CREDENTIAL, ACCOUNT_LOCK, USER_IS_NOT_STAFF } = require('../utilities/ResponseHelper/ResponseDescriptionKeyPair');
...
exports.loginStaff = async (req, res) => {
    ...
    try {
        ...
        if(!findStaffInClinic) throw new HttpUnprocessedRequest('AUTH005/5', INVALID_CREDENTIAL);
