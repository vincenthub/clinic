...
const StaffInfoModel = require('../mongo_models/users/StaffInfoModel');
...
exports.login = async (req, res) => {
    ...
    try {
        ...
        const { email, password } = req.body; //access_type [admin, staff, default]

        //check user exist
        const findUser = findUser = await modelValue.findOne({ user_email: email });
