...
exports.login = async (req, res) => {
    ...
    try {
        ...
        if(numberOfAttempts >= attepmts) return ErrorResponse(res, loginApiFunction, BAD_REQUEST, ACCOUNT_LOCKED)
        ...
        if(!isPassMatch){
            ...
            ErrorResponse(res, loginApiFunction, BAD_REQUEST, WRONG_CREDENTIALS) 
        }
