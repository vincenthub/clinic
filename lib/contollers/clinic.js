const ClinicDetailsModel = require('../mongo_models/clinics/clinicDetails');
...
const ClinicAddressModel = require('../mongo_models/users/addressDetails');
...
const ClinicSchedulModel = require('../mongo_models/clinics/clinicSchedule');
...
exports.registerClinic = async (req, res) => {
    ...
    try {
        ...
        //check user exist
        const findUser = await AppUserModel.findOne({ _id: userID });
